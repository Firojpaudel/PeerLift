    ...
    <div className="min-h-screen flex bg-bg-primary">
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-8 z-10 bg-bg-primary relative md:w-1/2">
        <div className="w-full max-w-7xl absolute top-0 left-0 right-0 p-8 flex justify-start">
           <a href="/" className="text-primary-600 font-display font-extrabold text-3xl tracking-tight hover:text-primary-700 transition-colors">PeerLift</a>
        </div>
        <div className="w-full max-w-[400px] mt-12 mb-12">
          {children}
        </div>
      </div>
