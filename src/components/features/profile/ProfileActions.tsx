  ...
  return (
    <>
      <div className="flex items-center justify-end gap-3 shrink-0 pt-4 md:pt-0">
        ...
        <Link href="/sessions/chat" className="inline-flex items-center justify-center font-semibold text-text-primary hover:bg-bg-secondary rounded-xl text-[15px] px-5 h-[42px] transition-colors">
            Message
